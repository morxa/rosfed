...
Source0:        https://github.com/ros-gbp/gl_dependency-release/archive/release/melodic/gl_dependency/1.1.0-0.tar.gz#/ros-melodic-gl_dependency-1.1.0-source0.tar.gz
...
Provides:  ros-melodic-gl_dependency = 1.1.0-3
Obsoletes: ros-melodic-gl_dependency < 1.1.0-3
Obsoletes: ros-kinetic-gl_dependency < 1.1.0-3
...
Provides: ros-melodic-gl_dependency-devel = 1.1.0-3
Obsoletes: ros-melodic-gl_dependency-devel < 1.1.0-3
Obsoletes: ros-kinetic-gl_dependency-devel < 1.1.0-3
