...
Source0:        https://github.com/ros-gbp/bond_core-release/archive/release/melodic/bond/1.8.3-0.tar.gz#/ros-melodic-bond-1.8.3-source0.tar.gz
...
Provides:  ros-melodic-bond = 1.8.3-1
Obsoletes: ros-melodic-bond < 1.8.3-1
...
Provides: ros-melodic-bond-devel = 1.8.3-1
Obsoletes: ros-melodic-bond-devel < 1.8.3-1
