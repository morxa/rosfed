...
Source0:        https://github.com/ros-gbp/webkit_dependency-release/archive/release/kinetic/webkit_dependency/1.1.0-0.tar.gz#/ros-kinetic-webkit_dependency-1.1.0-source0.tar.gz
...
Provides:  ros-kinetic-webkit_dependency = %{version}-%{release}
Obsoletes: ros-kinetic-webkit_dependency < %{version}-%{release}
...
Provides: ros-kinetic-webkit_dependency-devel = %{version}-%{release}
Obsoletes: ros-kinetic-webkit_dependency-devel < %{version}-%{release}
