...
Source0:        https://github.com/ros-gbp/image_transport_plugins-release/archive/release/noetic/compressed_depth_image_transport/1.14.0-1.tar.gz#/ros-noetic-compressed_depth_image_transport-1.14.0-source0.tar.gz
...
Provides:  ros-noetic-compressed_depth_image_transport = 1.14.0-1
Obsoletes: ros-noetic-compressed_depth_image_transport < 1.14.0-1
