...
Source0:        https://github.com/ros-gbp/geometry2-release/archive/release/melodic/tf2_msgs/0.6.5-0.tar.gz#/ros-melodic-tf2_msgs-0.6.5-source0.tar.gz
...
Provides:  ros-melodic-tf2_msgs = 0.6.5-1
Obsoletes: ros-melodic-tf2_msgs < 0.6.5-1
...
Provides: ros-melodic-tf2_msgs-devel = 0.6.5-1
Obsoletes: ros-melodic-tf2_msgs-devel < 0.6.5-1
