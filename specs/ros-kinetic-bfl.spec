...
Version:        0.7.0
Release:        1%{?dist}
Summary:        ROS package bfl

License:        LGPL
URL:            http://ros.org/wiki/bfl

Source0:        https://github.com/ros-gbp/bfl-release/archive/release/kinetic/bfl/0.7.0-2.tar.gz#/ros-kinetic-bfl-0.7.0-source0.tar.gz
...
the library, because BFL is not available from an OS package manager.
This ROS package compiles BFL with the Boost library for matrix
...
%changelog
* Wed Jun 06 2018 Till Hofmann <thofmann@fedoraproject.org> - 0.7.0-1
- Initial package
