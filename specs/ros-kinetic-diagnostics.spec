...
Source0:        https://github.com/ros-gbp/diagnostics-release/archive/release/kinetic/diagnostics/1.9.3-0.tar.gz#/ros-kinetic-diagnostics-1.9.3-source0.tar.gz
...
Provides:  ros-kinetic-diagnostics = %{version}-%{release}
Obsoletes: ros-kinetic-diagnostics < %{version}-%{release}

%package        devel
Summary:        Development files for %{name}
Requires:       %{name} = %{version}-%{release}
Requires:       ros-kinetic-catkin-devel
Requires:       ros-kinetic-diagnostic_aggregator-devel
Requires:       ros-kinetic-diagnostic_analysis-devel
Requires:       ros-kinetic-diagnostic_common_diagnostics-devel
Requires:       ros-kinetic-diagnostic_updater-devel
Requires:       ros-kinetic-self_test-devel

%description devel
The %{name}-devel package contains libraries and header files for developing
applications that use %{name}.

Provides: ros-kinetic-diagnostics-devel = %{version}-%{release}
Obsoletes: ros-kinetic-diagnostics-devel < %{version}-%{release}
