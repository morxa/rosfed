...
Source0:        https://github.com/ros-gbp/ros-release/archive/release/noetic/mk/1.15.7-1.tar.gz#/ros-noetic-mk-1.15.7-source0.tar.gz
...
Provides:  ros-noetic-mk = 1.15.7-2
Obsoletes: ros-noetic-mk < 1.15.7-2
Obsoletes: ros-kinetic-mk < 1.15.7-2
...
for the build of the package. The other files in this package are
intended for use in exotic situations that mostly arise when importing
3rdparty code.
...
Provides: ros-noetic-mk-devel = 1.15.7-2
Obsoletes: ros-noetic-mk-devel < 1.15.7-2
Obsoletes: ros-kinetic-mk-devel < 1.15.7-2
...
find %{buildroot}/%{_libdir}/ros/{include,lib*/pkgconfig,share/mk/cmake} \
