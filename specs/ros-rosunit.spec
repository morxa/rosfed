...
Provides:  ros-noetic-rosunit = 1.15.7-2
Obsoletes: ros-noetic-rosunit < 1.15.7-2
Obsoletes: ros-kinetic-rosunit < 1.15.7-2
...
Provides: ros-noetic-rosunit-devel = 1.15.7-2
Obsoletes: ros-noetic-rosunit-devel < 1.15.7-2
Obsoletes: ros-kinetic-rosunit-devel < 1.15.7-2
...
find %{buildroot}/%{_libdir}/ros/{include,lib*/pkgconfig,share/rosunit/cmake} \
