...
Source0:        https://github.com/ros-gbp/geometry2-release/archive/release/noetic/tf2_ros/0.7.5-1.tar.gz#/ros-noetic-tf2_ros-0.7.5-source0.tar.gz
...
Provides:  ros-noetic-tf2_ros = 0.7.5-1
Obsoletes: ros-noetic-tf2_ros < 0.7.5-1
Obsoletes: ros-kinetic-tf2_ros < 0.7.5-1
...
Provides: ros-noetic-tf2_ros-devel = 0.7.5-1
Obsoletes: ros-noetic-tf2_ros-devel < 0.7.5-1
Obsoletes: ros-kinetic-tf2_ros-devel < 0.7.5-1
