...
Source0:        https://github.com/ros-gbp/ros-release/archive/release/noetic/rosclean/1.15.7-1.tar.gz#/ros-noetic-rosclean-1.15.7-source0.tar.gz
...
Provides:  ros-noetic-rosclean = 1.15.7-2
Obsoletes: ros-noetic-rosclean < 1.15.7-2
Obsoletes: ros-kinetic-rosclean < 1.15.7-2
...
Provides: ros-noetic-rosclean-devel = 1.15.7-2
Obsoletes: ros-noetic-rosclean-devel < 1.15.7-2
Obsoletes: ros-kinetic-rosclean-devel < 1.15.7-2
...
find %{buildroot}/%{_libdir}/ros/{include,lib*/pkgconfig,share/rosclean/cmake} \
