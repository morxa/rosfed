...
Source0:        https://github.com/ros-gbp/image_pipeline-release/archive/release/noetic/image_proc/1.15.3-1.tar.gz#/ros-noetic-image_proc-1.15.3-source0.tar.gz
...
Provides:  ros-noetic-image_proc = 1.15.3-1
Obsoletes: ros-noetic-image_proc < 1.15.3-1
Obsoletes: ros-kinetic-image_proc < 1.15.3-1
...
Provides: ros-noetic-image_proc-devel = 1.15.3-1
Obsoletes: ros-noetic-image_proc-devel < 1.15.3-1
Obsoletes: ros-kinetic-image_proc-devel < 1.15.3-1
