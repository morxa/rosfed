...
Source0:        https://github.com/ros-gbp/executive_smach-release/archive/release/kinetic/smach_msgs/2.0.1-0.tar.gz#/ros-kinetic-smach_msgs-2.0.1-source0.tar.gz
...
BuildRequires:  ros-kinetic-message_runtime-devel
