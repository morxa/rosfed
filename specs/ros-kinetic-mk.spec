...
Provides:  ros-kinetic-mk = %{version}-%{release}
Obsoletes: ros-kinetic-mk < %{version}-%{release}
...
Provides: ros-kinetic-mk-devel = %{version}-%{release}
Obsoletes: ros-kinetic-mk-devel < %{version}-%{release}
