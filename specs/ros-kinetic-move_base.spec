...
Source0:        https://github.com/ros-gbp/navigation-release/archive/release/kinetic/move_base/1.14.4-0.tar.gz#/ros-kinetic-move_base-1.14.4-source0.tar.gz
...
BuildRequires:  ros-kinetic-clear_costmap_recovery-devel
