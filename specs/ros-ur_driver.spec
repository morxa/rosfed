Name:           ros-kinetic-ur_driver
Version:        1.2.1
Release:        1%{?dist}
Summary:        ROS package ur_driver

License:        BSD
URL:            http://ros.org/wiki/ur_driver

Source0:        https://github.com/ros-industrial-release/universal_robot-release/archive/release/kinetic/ur_driver/1.2.1-0.tar.gz#/ros-kinetic-ur_driver-1.2.1-source0.tar.gz
