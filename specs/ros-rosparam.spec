...
Source0:        https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/rosparam/1.15.8-1.tar.gz#/ros-noetic-rosparam-1.15.8-source0.tar.gz
...
Provides:  ros-noetic-rosparam = 1.15.8-1
Obsoletes: ros-noetic-rosparam < 1.15.8-1
Obsoletes: ros-kinetic-rosparam < 1.15.8-1
...
Provides: ros-noetic-rosparam-devel = 1.15.8-1
Obsoletes: ros-noetic-rosparam-devel < 1.15.8-1
Obsoletes: ros-kinetic-rosparam-devel < 1.15.8-1
