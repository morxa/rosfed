...
Source0:        https://github.com/ros-gbp/joint_state_publisher-release/archive/release/noetic/joint_state_publisher_gui/1.15.1-1.tar.gz#/ros-noetic-joint_state_publisher_gui-1.15.1-source0.tar.gz
...
Provides:  ros-noetic-joint_state_publisher_gui = 1.15.1-1
Obsoletes: ros-noetic-joint_state_publisher_gui < 1.15.1-1
Obsoletes: ros-kinetic-joint_state_publisher_gui < 1.15.1-1
...
Provides: ros-noetic-joint_state_publisher_gui-devel = 1.15.1-1
Obsoletes: ros-noetic-joint_state_publisher_gui-devel < 1.15.1-1
Obsoletes: ros-kinetic-joint_state_publisher_gui-devel < 1.15.1-1
