...
Provides:  ros-melodic-genlisp = 0.4.16-1
Obsoletes: ros-melodic-genlisp < 0.4.16-1
...
Provides: ros-melodic-genlisp-devel = 0.4.16-1
Obsoletes: ros-melodic-genlisp-devel < 0.4.16-1
...
%changelog
* Sat Jul 13 2019 Till Hofmann <thofmann@fedoraproject.org> - melodic.0.4.16-1
