...
Source0:        https://github.com/ros-gbp/geometry2-release/archive/release/kinetic/tf2_py/0.5.20-0.tar.gz#/ros-kinetic-tf2_py-0.5.20-source0.tar.gz
...
Provides:  ros-kinetic-tf2_py = %{version}-%{release}
Obsoletes: ros-kinetic-tf2_py < %{version}-%{release}
...
Provides: ros-kinetic-tf2_py-devel = %{version}-%{release}
Obsoletes: ros-kinetic-tf2_py-devel < %{version}-%{release}
