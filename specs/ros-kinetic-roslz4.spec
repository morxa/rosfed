...
Source0:        https://github.com/ros-gbp/ros_comm-release/archive/release/kinetic/roslz4/1.12.14-0.tar.gz#/ros-kinetic-roslz4-1.12.14-source0.tar.gz
...
Provides:  ros-kinetic-roslz4 = %{version}-%{release}
Obsoletes: ros-kinetic-roslz4 < %{version}-%{release}
...
Provides: ros-kinetic-roslz4-devel = %{version}-%{release}
Obsoletes: ros-kinetic-roslz4-devel < %{version}-%{release}
