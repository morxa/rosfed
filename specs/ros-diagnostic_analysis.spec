...
Source0:        https://github.com/ros-gbp/diagnostics-release/archive/release/noetic/diagnostic_analysis/1.10.4-1.tar.gz#/ros-noetic-diagnostic_analysis-1.10.4-source0.tar.gz
...
Provides:  ros-noetic-diagnostic_analysis = 1.10.4-1
Obsoletes: ros-noetic-diagnostic_analysis < 1.10.4-1
Obsoletes: ros-kinetic-diagnostic_analysis < 1.10.4-1
...
Provides: ros-noetic-diagnostic_analysis-devel = 1.10.4-1
Obsoletes: ros-noetic-diagnostic_analysis-devel < 1.10.4-1
Obsoletes: ros-kinetic-diagnostic_analysis-devel < 1.10.4-1
...
find %{buildroot}/%{_libdir}/ros/{include,lib*/pkgconfig,share/diagnostic_analysis/cmake} \
