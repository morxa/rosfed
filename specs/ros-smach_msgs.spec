...
Source0:        https://github.com/ros-gbp/executive_smach-release/archive/release/melodic/smach_msgs/2.0.1-0.tar.gz#/ros-melodic-smach_msgs-2.0.1-source0.tar.gz
...
Provides:  ros-melodic-smach_msgs = 2.0.1-1
Obsoletes: ros-melodic-smach_msgs < 2.0.1-1
...
Provides: ros-melodic-smach_msgs-devel = 2.0.1-1
Obsoletes: ros-melodic-smach_msgs-devel < 2.0.1-1
