...
Source0:        https://github.com/ros-gbp/ros_comm-release/archive/release/kinetic/rosnode/1.12.14-0.tar.gz#/ros-kinetic-rosnode-1.12.14-source0.tar.gz
...
Provides:  ros-kinetic-rosnode = %{version}-%{release}
Obsoletes: ros-kinetic-rosnode < %{version}-%{release}
...
Provides: ros-kinetic-rosnode-devel = %{version}-%{release}
Obsoletes: ros-kinetic-rosnode-devel < %{version}-%{release}
