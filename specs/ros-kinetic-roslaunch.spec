...
Source0:        https://github.com/ros-gbp/ros_comm-release/archive/release/kinetic/roslaunch/1.12.14-0.tar.gz#/ros-kinetic-roslaunch-1.12.14-source0.tar.gz
...
Provides:  ros-kinetic-roslaunch = %{version}-%{release}
Obsoletes: ros-kinetic-roslaunch < %{version}-%{release}
...
Provides: ros-kinetic-roslaunch-devel = %{version}-%{release}
Obsoletes: ros-kinetic-roslaunch-devel < %{version}-%{release}
