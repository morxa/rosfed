...
Source0:        https://github.com/ros-gbp/ros_tutorials-release/archive/release/kinetic/ros_tutorials/0.7.1-0.tar.gz#/ros-kinetic-ros_tutorials-0.7.1-source0.tar.gz
...
Requires:       ros-kinetic-roscpp_tutorials
Requires:       ros-kinetic-rospy_tutorials
...
Provides:  ros-kinetic-ros_tutorials = %{version}-%{release}
Obsoletes: ros-kinetic-ros_tutorials < %{version}-%{release}
...
Provides: ros-kinetic-ros_tutorials-devel = %{version}-%{release}
Obsoletes: ros-kinetic-ros_tutorials-devel < %{version}-%{release}
