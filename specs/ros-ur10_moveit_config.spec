Name:           ros-kinetic-ur10_moveit_config
Version:        1.2.1
Release:        1%{?dist}
Summary:        ROS package ur10_moveit_config

License:        BSD
URL:            http://moveit.ros.org/

Source0:        https://github.com/ros-industrial-release/universal_robot-release/archive/release/kinetic/ur10_moveit_config/1.2.1-0.tar.gz#/ros-kinetic-ur10_moveit_config-1.2.1-source0.tar.gz
...
launch files for using the ur10 with the MoveIt Motion Planning
Framework
