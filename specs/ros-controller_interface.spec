...
Source0:        https://github.com/ros-gbp/ros_control-release/archive/release/melodic/controller_interface/0.18.0-1.tar.gz#/ros-melodic-controller_interface-0.18.0-source0.tar.gz
...
Provides:  ros-melodic-controller_interface = 0.18.0-1
Obsoletes: ros-melodic-controller_interface < 0.18.0-1
Obsoletes: ros-kinetic-controller_interface < 0.18.0-1
...
Provides: ros-melodic-controller_interface-devel = 0.18.0-1
Obsoletes: ros-melodic-controller_interface-devel < 0.18.0-1
Obsoletes: ros-kinetic-controller_interface-devel < 0.18.0-1
