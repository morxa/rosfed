...
Source0:        https://github.com/ros-gbp/ros_control-release/archive/release/noetic/controller_interface/0.19.4-1.tar.gz#/ros-noetic-controller_interface-0.19.4-source0.tar.gz
...
Provides:  ros-noetic-controller_interface = 0.19.4-2
Obsoletes: ros-noetic-controller_interface < 0.19.4-2
Obsoletes: ros-kinetic-controller_interface < 0.19.4-2
...
Provides: ros-noetic-controller_interface-devel = 0.19.4-2
Obsoletes: ros-noetic-controller_interface-devel < 0.19.4-2
Obsoletes: ros-kinetic-controller_interface-devel < 0.19.4-2
