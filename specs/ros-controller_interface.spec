...
Source0:        https://github.com/ros-gbp/ros_control-release/archive/release/noetic/controller_interface/0.19.1-1.tar.gz#/ros-noetic-controller_interface-0.19.1-source0.tar.gz
...
Provides:  ros-noetic-controller_interface = 0.19.1-1
Obsoletes: ros-noetic-controller_interface < 0.19.1-1
