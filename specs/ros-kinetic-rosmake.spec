...
Source0:        https://github.com/ros-gbp/ros-release/archive/release/kinetic/rosmake/1.14.6-1.tar.gz#/ros-kinetic-rosmake-1.14.6-source0.tar.gz
...
Provides:  ros-kinetic-rosmake = %{version}-%{release}
Obsoletes: ros-kinetic-rosmake < %{version}-%{release}
...
Provides: ros-kinetic-rosmake-devel = %{version}-%{release}
Obsoletes: ros-kinetic-rosmake-devel < %{version}-%{release}
