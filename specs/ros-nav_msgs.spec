...
Source0:        https://github.com/ros-gbp/common_msgs-release/archive/release/melodic/nav_msgs/1.12.7-0.tar.gz#/ros-melodic-nav_msgs-1.12.7-source0.tar.gz
...
Provides:  ros-melodic-nav_msgs = 1.12.7-1
Obsoletes: ros-melodic-nav_msgs < 1.12.7-1
...
Provides: ros-melodic-nav_msgs-devel = 1.12.7-1
Obsoletes: ros-melodic-nav_msgs-devel < 1.12.7-1
