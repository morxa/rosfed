...
Provides:  ros-kinetic-rqt_gui_py = %{version}-%{release}
Obsoletes: ros-kinetic-rqt_gui_py < %{version}-%{release}
...
Provides: ros-kinetic-rqt_gui_py-devel = %{version}-%{release}
Obsoletes: ros-kinetic-rqt_gui_py-devel < %{version}-%{release}
