...
Source0:        https://github.com/ros-gbp/moveit-release/archive/release/melodic/moveit_fake_controller_manager/1.0.3-1.tar.gz#/ros-melodic-moveit_fake_controller_manager-1.0.3-source0.tar.gz
...
Provides:  ros-melodic-moveit_fake_controller_manager = 1.0.3-1
Obsoletes: ros-melodic-moveit_fake_controller_manager < 1.0.3-1
Obsoletes: ros-kinetic-moveit_fake_controller_manager < 1.0.3-1
...
Provides: ros-melodic-moveit_fake_controller_manager-devel = 1.0.3-1
Obsoletes: ros-melodic-moveit_fake_controller_manager-devel < 1.0.3-1
Obsoletes: ros-kinetic-moveit_fake_controller_manager-devel < 1.0.3-1
