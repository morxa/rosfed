...
Source0:        https://github.com/ros-gbp/geometry-release/archive/release/kinetic/geometry/1.11.9-0.tar.gz#/ros-kinetic-geometry-1.11.9-source0.tar.gz
...
%description
ROS kinetic package geometry.

Provides:  ros-kinetic-geometry = %{version}-%{release}
Obsoletes: ros-kinetic-geometry < %{version}-%{release}
...
Provides: ros-kinetic-geometry-devel = %{version}-%{release}
Obsoletes: ros-kinetic-geometry-devel < %{version}-%{release}
