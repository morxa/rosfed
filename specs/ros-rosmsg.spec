...
Source0:        https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/rosmsg/1.15.13-1.tar.gz#/ros-noetic-rosmsg-1.15.13-source0.tar.gz
...
Provides:  ros-noetic-rosmsg = 1.15.13-1
Obsoletes: ros-noetic-rosmsg < 1.15.13-1
Obsoletes: ros-kinetic-rosmsg < 1.15.13-1
...
Provides: ros-noetic-rosmsg-devel = 1.15.13-1
Obsoletes: ros-noetic-rosmsg-devel < 1.15.13-1
Obsoletes: ros-kinetic-rosmsg-devel < 1.15.13-1
...
find %{buildroot}/%{_libdir}/ros/{include,lib*/pkgconfig,share/rosmsg/cmake} \
