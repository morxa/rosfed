...
Source0:        https://github.com/ros-gbp/rqt_py_console-release/archive/release/noetic/rqt_py_console/0.4.9-1.tar.gz#/ros-noetic-rqt_py_console-0.4.9-source0.tar.gz
...
Provides:  ros-noetic-rqt_py_console = 0.4.9-2
Obsoletes: ros-noetic-rqt_py_console < 0.4.9-2
Obsoletes: ros-kinetic-rqt_py_console < 0.4.9-2
...
Provides: ros-noetic-rqt_py_console-devel = 0.4.9-2
Obsoletes: ros-noetic-rqt_py_console-devel < 0.4.9-2
Obsoletes: ros-kinetic-rqt_py_console-devel < 0.4.9-2
