Name:           ros-rqt_py_console
Version:        noetic.0.4.10
Release:        1%{?dist}
Summary:        ROS package rqt_py_console

License:        BSD
URL:            http://wiki.ros.org/rqt_py_console

Source0:        https://github.com/ros-gbp/rqt_py_console-release/archive/release/noetic/rqt_py_console/0.4.10-1.tar.gz#/ros-noetic-rqt_py_console-0.4.10-source0.tar.gz
...
Provides:  ros-noetic-rqt_py_console = 0.4.10-1
Obsoletes: ros-noetic-rqt_py_console < 0.4.10-1
Obsoletes: ros-kinetic-rqt_py_console < 0.4.10-1
...
Provides: ros-noetic-rqt_py_console-devel = 0.4.10-1
Obsoletes: ros-noetic-rqt_py_console-devel < 0.4.10-1
Obsoletes: ros-kinetic-rqt_py_console-devel < 0.4.10-1
...
find %{buildroot}/%{_libdir}/ros/{include,lib*/pkgconfig,share/rqt_py_console/cmake} \
