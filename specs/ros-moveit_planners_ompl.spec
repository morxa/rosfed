...
Source0:        https://github.com/ros-gbp/moveit-release/archive/release/melodic/moveit_planners_ompl/1.0.3-1.tar.gz#/ros-melodic-moveit_planners_ompl-1.0.3-source0.tar.gz
...
BuildRequires:  ros-melodic-ompl-devel
...
Provides:  ros-melodic-moveit_planners_ompl = 1.0.3-1
Obsoletes: ros-melodic-moveit_planners_ompl < 1.0.3-1
Obsoletes: ros-kinetic-moveit_planners_ompl < 1.0.3-1
...
Requires:       ros-melodic-ompl-devel
...
Provides: ros-melodic-moveit_planners_ompl-devel = 1.0.3-1
Obsoletes: ros-melodic-moveit_planners_ompl-devel < 1.0.3-1
Obsoletes: ros-kinetic-moveit_planners_ompl-devel < 1.0.3-1
