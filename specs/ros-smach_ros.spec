...
Provides:  ros-noetic-smach_ros = 2.5.0-2
Obsoletes: ros-noetic-smach_ros < 2.5.0-2
Obsoletes: ros-kinetic-smach_ros < 2.5.0-2
...
Provides: ros-noetic-smach_ros-devel = 2.5.0-2
Obsoletes: ros-noetic-smach_ros-devel < 2.5.0-2
Obsoletes: ros-kinetic-smach_ros-devel < 2.5.0-2
...
find %{buildroot}/%{_libdir}/ros/{include,lib*/pkgconfig,share/smach_ros/cmake} \
