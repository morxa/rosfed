...
Provides:  ros-noetic-rqt_runtime_monitor = 0.5.9-2
Obsoletes: ros-noetic-rqt_runtime_monitor < 0.5.9-2
Obsoletes: ros-kinetic-rqt_runtime_monitor < 0.5.9-2
...
Provides: ros-noetic-rqt_runtime_monitor-devel = 0.5.9-2
Obsoletes: ros-noetic-rqt_runtime_monitor-devel < 0.5.9-2
Obsoletes: ros-kinetic-rqt_runtime_monitor-devel < 0.5.9-2
...
find %{buildroot}/%{_libdir}/ros/{include,lib*/pkgconfig,share/rqt_runtime_monitor/cmake} \
...
%changelog
* Thu Oct 14 2021 Till Hofmann <thofmann@fedoraproject.org> - noetic.0.5.9-2
