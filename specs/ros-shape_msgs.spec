...
Source0:        https://github.com/ros-gbp/common_msgs-release/archive/release/noetic/shape_msgs/1.13.1-1.tar.gz#/ros-noetic-shape_msgs-1.13.1-source0.tar.gz
...
Provides:  ros-noetic-shape_msgs = 1.13.1-3
Obsoletes: ros-noetic-shape_msgs < 1.13.1-3
Obsoletes: ros-kinetic-shape_msgs < 1.13.1-3
...
Provides: ros-noetic-shape_msgs-devel = 1.13.1-3
Obsoletes: ros-noetic-shape_msgs-devel < 1.13.1-3
Obsoletes: ros-kinetic-shape_msgs-devel < 1.13.1-3
...
find %{buildroot}/%{_libdir}/ros/{include,lib*/pkgconfig,share/shape_msgs/cmake} \
