...
Source0:        https://github.com/ros-gbp/common_msgs-release/archive/release/kinetic/nav_msgs/1.12.7-0.tar.gz#/ros-kinetic-nav_msgs-1.12.7-source0.tar.gz
...
Provides:  ros-kinetic-nav_msgs = %{version}-%{release}
Obsoletes: ros-kinetic-nav_msgs < %{version}-%{release}
...
Provides: ros-kinetic-nav_msgs-devel = %{version}-%{release}
Obsoletes: ros-kinetic-nav_msgs-devel < %{version}-%{release}
