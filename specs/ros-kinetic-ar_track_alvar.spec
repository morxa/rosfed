Name:           ros-kinetic-ar_track_alvar
Version:        0.7.1
Release:        1%{?dist}
Summary:        ROS package ar_track_alvar

License:        LGPL-2.1
URL:            http://ros.org/wiki/ar_track_alvar

Source0:        https://github.com/ros-gbp/ar_track_alvar-release/archive/release/kinetic/ar_track_alvar/0.7.1-0.tar.gz#/ros-kinetic-ar_track_alvar-0.7.1-source0.tar.gz
...
BuildRequires:  ros-kinetic-ar_track_alvar_msgs-devel
...
Requires:       ros-kinetic-ar_track_alvar_msgs
...
%description
This package is a ROS wrapper for Alvar, an open source AR tag
tracking library.
...
Requires:       ros-kinetic-ar_track_alvar_msgs-devel
...
%changelog
* Tue Apr 30 2019 Till Hofmann <thofmann@fedoraproject.org> - 0.7.1-1
- Initial package
