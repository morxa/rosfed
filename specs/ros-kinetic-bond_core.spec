...
Source0:        https://github.com/ros-gbp/bond_core-release/archive/release/kinetic/bond_core/1.8.3-0.tar.gz#/ros-kinetic-bond_core-1.8.3-source0.tar.gz
...
Provides:  ros-kinetic-bond_core = %{version}-%{release}
Obsoletes: ros-kinetic-bond_core < %{version}-%{release}
...
Provides: ros-kinetic-bond_core-devel = %{version}-%{release}
Obsoletes: ros-kinetic-bond_core-devel < %{version}-%{release}
...
* Tue May 22 2018 Till Hofmann <thofmann@fedoraproject.org> - 1.8.1-7
- devel also requires: the devel package of each run dependency
