...
Source0:        https://github.com/ros-gbp/bond_core-release/archive/release/kinetic/bondpy/1.8.3-0.tar.gz#/ros-kinetic-bondpy-1.8.3-source0.tar.gz
...
BuildRequires:  ros-kinetic-bond-devel
