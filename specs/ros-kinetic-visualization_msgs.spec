...
Source0:        https://github.com/ros-gbp/common_msgs-release/archive/release/kinetic/visualization_msgs/1.12.7-0.tar.gz#/ros-kinetic-visualization_msgs-1.12.7-source0.tar.gz
...
Provides:  ros-kinetic-visualization_msgs = %{version}-%{release}
Obsoletes: ros-kinetic-visualization_msgs < %{version}-%{release}
...
Provides: ros-kinetic-visualization_msgs-devel = %{version}-%{release}
Obsoletes: ros-kinetic-visualization_msgs-devel < %{version}-%{release}
