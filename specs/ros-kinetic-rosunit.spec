...
Source0:        https://github.com/ros-gbp/ros-release/archive/release/kinetic/rosunit/1.14.6-1.tar.gz#/ros-kinetic-rosunit-1.14.6-source0.tar.gz
...
Provides:  ros-kinetic-rosunit = %{version}-%{release}
Obsoletes: ros-kinetic-rosunit < %{version}-%{release}
...
Provides: ros-kinetic-rosunit-devel = %{version}-%{release}
Obsoletes: ros-kinetic-rosunit-devel < %{version}-%{release}
