...
Provides:  ros-kinetic-python_orocos_kdl = %{version}-%{release}
Obsoletes: ros-kinetic-python_orocos_kdl < %{version}-%{release}
...
Provides: ros-kinetic-python_orocos_kdl-devel = %{version}-%{release}
Obsoletes: ros-kinetic-python_orocos_kdl-devel < %{version}-%{release}
