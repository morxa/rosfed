...
Source0:        https://github.com/ros-gbp/ros_controllers-release/archive/release/noetic/position_controllers/0.21.0-1.tar.gz#/ros-noetic-position_controllers-0.21.0-source0.tar.gz
...
Provides:  ros-noetic-position_controllers = 0.21.0-1
Obsoletes: ros-noetic-position_controllers < 0.21.0-1
Obsoletes: ros-kinetic-position_controllers < 0.21.0-1
...
Provides: ros-noetic-position_controllers-devel = 0.21.0-1
Obsoletes: ros-noetic-position_controllers-devel < 0.21.0-1
Obsoletes: ros-kinetic-position_controllers-devel < 0.21.0-1
...
find %{buildroot}/%{_libdir}/ros/{include,lib*/pkgconfig,share/position_controllers/cmake} \
...
%changelog
* Mon Dec 26 2022 Tarik Viehmann <viehmann@kbsg.rwth-aachen.de> - noetic.0.21.0-1
- Update to latest release
* Mon Jun 06 2022 Till Hofmann <thofmann@fedoraproject.org> - noetic.0.20.0-1
- Update to latest release
