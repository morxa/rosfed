...
Source0:        https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/topic_tools/1.15.9-1.tar.gz#/ros-noetic-topic_tools-1.15.9-source0.tar.gz
...
Provides:  ros-noetic-topic_tools = 1.15.9-2
Obsoletes: ros-noetic-topic_tools < 1.15.9-2
Obsoletes: ros-kinetic-topic_tools < 1.15.9-2
...
Provides: ros-noetic-topic_tools-devel = 1.15.9-2
Obsoletes: ros-noetic-topic_tools-devel < 1.15.9-2
Obsoletes: ros-kinetic-topic_tools-devel < 1.15.9-2
