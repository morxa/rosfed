...
Source0:        https://github.com/ros-gbp/common_msgs-release/archive/release/kinetic/actionlib_msgs/1.12.7-0.tar.gz#/ros-kinetic-actionlib_msgs-1.12.7-source0.tar.gz
...
Provides:  ros-kinetic-actionlib_msgs = %{version}-%{release}
Obsoletes: ros-kinetic-actionlib_msgs < %{version}-%{release}
...
Provides: ros-kinetic-actionlib_msgs-devel = %{version}-%{release}
Obsoletes: ros-kinetic-actionlib_msgs-devel < %{version}-%{release}
