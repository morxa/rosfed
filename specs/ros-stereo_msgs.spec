...
Source0:        https://github.com/ros-gbp/common_msgs-release/archive/release/noetic/stereo_msgs/1.13.1-1.tar.gz#/ros-noetic-stereo_msgs-1.13.1-source0.tar.gz
...
Provides:  ros-noetic-stereo_msgs = 1.13.1-3
Obsoletes: ros-noetic-stereo_msgs < 1.13.1-3
Obsoletes: ros-kinetic-stereo_msgs < 1.13.1-3
...
Provides: ros-noetic-stereo_msgs-devel = 1.13.1-3
Obsoletes: ros-noetic-stereo_msgs-devel < 1.13.1-3
Obsoletes: ros-kinetic-stereo_msgs-devel < 1.13.1-3
...
find %{buildroot}/%{_libdir}/ros/{include,lib*/pkgconfig,share/stereo_msgs/cmake} \
