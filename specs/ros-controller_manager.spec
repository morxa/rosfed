...
Provides:  ros-noetic-controller_manager = 0.19.4-2
Obsoletes: ros-noetic-controller_manager < 0.19.4-2
Obsoletes: ros-kinetic-controller_manager < 0.19.4-2
...
Provides: ros-noetic-controller_manager-devel = 0.19.4-2
Obsoletes: ros-noetic-controller_manager-devel < 0.19.4-2
Obsoletes: ros-kinetic-controller_manager-devel < 0.19.4-2
...
find %{buildroot}/%{_libdir}/ros/{include,lib*/pkgconfig,share/controller_manager/cmake} \
