...
Source0:        https://github.com/ros-gbp/ros-release/archive/release/noetic/rosbash/1.15.8-1.tar.gz#/ros-noetic-rosbash-1.15.8-source0.tar.gz
...
Provides:  ros-noetic-rosbash = 1.15.8-1
Obsoletes: ros-noetic-rosbash < 1.15.8-1
Obsoletes: ros-kinetic-rosbash < 1.15.8-1
...
Provides: ros-noetic-rosbash-devel = 1.15.8-1
Obsoletes: ros-noetic-rosbash-devel < 1.15.8-1
Obsoletes: ros-kinetic-rosbash-devel < 1.15.8-1
...
find %{buildroot}/%{_libdir}/ros/{include,lib*/pkgconfig,share/rosbash/cmake} \
