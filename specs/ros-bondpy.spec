...
Source0:        https://github.com/ros-gbp/bond_core-release/archive/release/melodic/bondpy/1.8.3-0.tar.gz#/ros-melodic-bondpy-1.8.3-source0.tar.gz
...
Provides:  ros-melodic-bondpy = 1.8.3-1
Obsoletes: ros-melodic-bondpy < 1.8.3-1
...
Provides: ros-melodic-bondpy-devel = 1.8.3-1
Obsoletes: ros-melodic-bondpy-devel < 1.8.3-1
