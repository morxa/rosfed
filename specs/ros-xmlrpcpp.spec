...
Source0:        https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/xmlrpcpp/1.15.15-1.tar.gz#/ros-noetic-xmlrpcpp-1.15.15-source0.tar.gz
...
Provides:  ros-noetic-xmlrpcpp = 1.15.15-1
Obsoletes: ros-noetic-xmlrpcpp < 1.15.15-1
Obsoletes: ros-kinetic-xmlrpcpp < 1.15.15-1
...
to support roscpp's threading model. As such, we are maintaining our
own fork.
...
Provides: ros-noetic-xmlrpcpp-devel = 1.15.15-1
Obsoletes: ros-noetic-xmlrpcpp-devel < 1.15.15-1
Obsoletes: ros-kinetic-xmlrpcpp-devel < 1.15.15-1
...
find %{buildroot}/%{_libdir}/ros/{include,lib*/pkgconfig,share/xmlrpcpp/cmake} \
