...
Source0:        https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/rosbag_storage/1.15.8-1.tar.gz#/ros-noetic-rosbag_storage-1.15.8-source0.tar.gz
...
Provides:  ros-noetic-rosbag_storage = 1.15.8-1
Obsoletes: ros-noetic-rosbag_storage < 1.15.8-1
Obsoletes: ros-kinetic-rosbag_storage < 1.15.8-1
...
Provides: ros-noetic-rosbag_storage-devel = 1.15.8-1
Obsoletes: ros-noetic-rosbag_storage-devel < 1.15.8-1
Obsoletes: ros-kinetic-rosbag_storage-devel < 1.15.8-1
