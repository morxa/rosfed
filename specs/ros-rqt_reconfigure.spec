...
Source0:        https://github.com/ros-gbp/rqt_reconfigure-release/archive/release/noetic/rqt_reconfigure/0.5.5-1.tar.gz#/ros-noetic-rqt_reconfigure-0.5.5-source0.tar.gz
...
Provides:  ros-noetic-rqt_reconfigure = 0.5.5-1
Obsoletes: ros-noetic-rqt_reconfigure < 0.5.5-1
Obsoletes: ros-kinetic-rqt_reconfigure < 0.5.5-1
...
Provides: ros-noetic-rqt_reconfigure-devel = 0.5.5-1
Obsoletes: ros-noetic-rqt_reconfigure-devel < 0.5.5-1
Obsoletes: ros-kinetic-rqt_reconfigure-devel < 0.5.5-1
...
%changelog
* Fri May 06 2022 Till Hofmann <thofmann@fedoraproject.org> - noetic.0.5.5-1
