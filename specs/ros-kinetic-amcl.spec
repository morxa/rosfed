...
Version:        1.14.3
Release:        1%{?dist}
Summary:        ROS package amcl

License:        LGPL
URL:            http://www.ros.org/

Source0:        https://github.com/ros-gbp/navigation-release/archive/release/kinetic/amcl/1.14.3-0.tar.gz#/ros-kinetic-amcl-1.14.3-source0.tar.gz
