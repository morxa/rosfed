...
Source0:        https://github.com/ros-gbp/ros-release/archive/release/noetic/rosbuild/1.15.7-1.tar.gz#/ros-noetic-rosbuild-1.15.7-source0.tar.gz
...
Provides:  ros-noetic-rosbuild = 1.15.7-2
Obsoletes: ros-noetic-rosbuild < 1.15.7-2
Obsoletes: ros-kinetic-rosbuild < 1.15.7-2
...
Provides: ros-noetic-rosbuild-devel = 1.15.7-2
Obsoletes: ros-noetic-rosbuild-devel < 1.15.7-2
Obsoletes: ros-kinetic-rosbuild-devel < 1.15.7-2
