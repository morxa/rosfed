...
Source0:        https://github.com/ros-gbp/geometry2-release/archive/release/kinetic/tf2_geometry_msgs/0.5.17-0.tar.gz#/ros-kinetic-tf2_geometry_msgs-0.5.17-source0.tar.gz
...
BuildRequires:  ros-kinetic-python_orocos_kdl-devel
