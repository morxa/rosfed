...
Source0:        https://github.com/ros-gbp/ros_comm-release/archive/release/kinetic/roscpp/1.12.14-0.tar.gz#/ros-kinetic-roscpp-1.12.14-source0.tar.gz
...
Provides:  ros-kinetic-roscpp = %{version}-%{release}
Obsoletes: ros-kinetic-roscpp < %{version}-%{release}
...
Provides: ros-kinetic-roscpp-devel = %{version}-%{release}
Obsoletes: ros-kinetic-roscpp-devel < %{version}-%{release}
